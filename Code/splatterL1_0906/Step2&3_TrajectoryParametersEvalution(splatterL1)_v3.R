...
# dir.create("PLOTS/Script_splatter_L1")
...
load("RDATA/step0_clean_splatter_L1.RData")
load("RDATA/step0_ss_splatter_L1.RData")
load("RDATA/step1_splatter_L1.RData")
...
pdf("PLOTS/Script_splatter_L1/gof_ss_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
gof_eval1 <- GOFeval(MDS1_eval, alpha=0.15)
...
pdf("PLOTS/Script_splatter_L1/ushape_ss_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
...
save(scoredf, final_df, file = "RDATA/res_splatter_L1.RData")
save.image(file = "RDATA/allres_splatter_L1.RData")
