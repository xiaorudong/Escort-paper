...
# dir.create("PLOTS/Script_dyntoy_DC1")
...
load("RDATA/step0_clean_dyntoy_DC1.RData")
load("RDATA/step0_m3_dyntoy_DC1.RData")
load("RDATA/step1_dyntoy_DC1.RData")
...
save(scoredf, final_df, file = "RDATA/res_m3_dyntoy_DC1.RData")
save.image(file = "RDATA/allres_m3_dyntoy_DC1.RData")
