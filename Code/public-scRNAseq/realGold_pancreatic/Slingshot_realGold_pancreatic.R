...
load("RDATA/Manuscript/clean_realGold_pancreatic.RData")
load("RDATA/Manuscript/dr_realGold_pancreatic.RData")
...
save(fitLines, resobjs, file = "RDATA/Manuscript/slingshot_realGold_pancreatic.RData")
