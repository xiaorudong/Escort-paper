...
save(norm_counts, rawcounts, scdata_time, 
     file = "RDATA/Manuscript/clean_realGold_pancreatic.RData")
...
save(embeddings, file = "RDATA/Manuscript/dr_realGold_pancreatic.RData")
...
# from Slingshot:
load("RDATA/Manuscript/slingshot_realGold_pancreatic.RData")
ushap_ss_evals <- mclapply(resobjs, UshapeDetector)
lapply(ushap_ss_evals, function(x) x$Ambpct)


# from Monocle3:
load("RDATA/Manuscript/Monocle3_realGold_pancreatic.RData")
