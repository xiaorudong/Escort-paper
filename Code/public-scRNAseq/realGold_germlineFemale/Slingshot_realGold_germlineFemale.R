...
load("RDATA/Manuscript/clean_realGold_germlineFemale.RData")
load("RDATA/Manuscript/dr_realGold_germlineFemale.RData")
...
save(fitLines, resobjs, file = "RDATA/Manuscript/slingshot_realGold_germlineFemale.RData")
