...
save(norm_counts, rawcounts, scdata_time, 
     file = "RDATA/Manuscript/clean_RealCollection1.RData")
...
save(embeddings, file = "RDATA/Manuscript/dr_RealCollection1.RData")
...
# from Slingshot:
load("RDATA/Manuscript/slingshot_RealCollection1.RData")
ushap_ss_evals <- mclapply(resobjs, UshapeDetector)
lapply(ushap_ss_evals, function(x) x$Ambpct)


# from Monocle3:
load("RDATA/Manuscript/Monocle3_RealCollection1.RData")
