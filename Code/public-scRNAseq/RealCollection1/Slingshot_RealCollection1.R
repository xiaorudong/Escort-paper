...
load("RDATA/Manuscript/clean_RealCollection1.RData")
load("RDATA/Manuscript/dr_RealCollection1.RData")
...
save(fitLines, resobjs, file = "RDATA/Manuscript/slingshot_RealCollection1.RData")
