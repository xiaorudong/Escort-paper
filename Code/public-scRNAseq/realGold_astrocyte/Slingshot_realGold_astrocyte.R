...
load("RDATA/Manuscript/clean_realGold_astrocyte.RData")
load("RDATA/Manuscript/dr_realGold_astrocyte.RData")
...
save(fitLines, resobjs, file = "RDATA/Manuscript/slingshot_realGold_astrocyte.RData")
