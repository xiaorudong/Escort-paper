...
save(norm_counts, rawcounts, scdata_time, 
     file = "RDATA/Manuscript/clean_realGold_ageHSC.RData")
...
save(embeddings, file = "RDATA/Manuscript/dr_realGold_ageHSC.RData")
...
# from Slingshot:
load("RDATA/Manuscript/slingshot_realGold_ageHSC.RData")
ushap_ss_evals <- mclapply(resobjs, UshapeDetector)
lapply(ushap_ss_evals, function(x) x$Ambpct)


# from Monocle3:
load("RDATA/Manuscript/Monocle3_realGold_ageHSC.RData")
