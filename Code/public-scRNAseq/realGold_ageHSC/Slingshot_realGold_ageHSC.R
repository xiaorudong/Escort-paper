...
load("RDATA/Manuscript/clean_realGold_ageHSC.RData")
load("RDATA/Manuscript/dr_realGold_ageHSC.RData")
...
save(fitLines, resobjs, file = "RDATA/Manuscript/slingshot_realGold_ageHSC.RData")
