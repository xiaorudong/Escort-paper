...
# dir.create("PLOTS/Script_sim_DEG20_500")
...
load("RDATA/step0_clean_sim_DEG20_500.RData")
load("RDATA/step0_ss_sim_DEG20_500.RData")
load("RDATA/step1_sim_DEG20_500.RData")
...
pdf("PLOTS/Script_sim_DEG20_500/gof_ss_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
gof_eval1 <- GOFeval(MDS1_eval, alpha = 0.2)
gof_eval2 <- GOFeval(MDS2_eval, alpha = 0.25)
...
pdf("PLOTS/Script_sim_DEG20_500/ushape_ss_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
...
save(scoredf, final_df, file = "RDATA/res_sim_DEG20_500.RData")
save.image(file = "RDATA/allres_sim_DEG20_500.RData")
