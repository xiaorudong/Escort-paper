...
load("RDATA/step0_m3_sim_DEG20_500.RData")
...
load("RDATA/res_sim_DEG20_500.RData")
...
pdf("PLOTS/Script_sim_DEG20_500/ushape_m3_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
...
save(scoredf, final_df, file = "RDATA/res_m3_sim_DEG20_500.RData")
save.image(file = "RDATA/allres_m3_sim_DEG20_500.RData")
