...
scdata <- readRDS("DATA/sc_benchmark/synthetic_dyntoy_linear_3.rds")
...
save(norm_counts, rawcounts, scdata_time, 
     file = "RDATA/Manuscript/clean_dyntoy_L3.RData")
...
save(embeddings, file = "RDATA/Manuscript/dr_dyntoy_L3.RData")
...
# from Slingshot:
load("RDATA/Manuscript/slingshot_dyntoyL3.RData")
ushap_ss_evals <- mclapply(resobjs, UshapeDetector)
lapply(ushap_ss_evals, function(x) x$Ambpct)


# from Monocle3:
load("RDATA/Manuscript/Monocle3_dyntoyL3.RData")
