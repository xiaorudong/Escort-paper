...
load("RDATA/Manuscript/clean_dyntoy_L3.RData")
load("RDATA/Manuscript/dr_dyntoy_L3.RData")
...
save(fitLines, resobjs, file = "RDATA/Manuscript/slingshot_dyntoyL3.RData")
