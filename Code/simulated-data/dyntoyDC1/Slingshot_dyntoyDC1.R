...
load("RDATA/Manuscript/clean_dyntoy_DC1.RData")
load("RDATA/Manuscript/dr_dyntoy_DC1.RData")
...
save(fitLines, resobjs, file = "RDATA/Manuscript/slingshot_dyntoyDC1.RData")
