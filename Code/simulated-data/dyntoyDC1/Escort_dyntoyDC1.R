...
scdata <- readRDS("DATA/sc_benchmark/synthetic_dyntoy_disconnected_1.rds")
...
save(norm_counts, rawcounts, scdata_time, 
     file = "RDATA/Manuscript/clean_dyntoy_DC1.RData")
...
save(embeddings, file = "RDATA/Manuscript/dr_dyntoy_DC1.RData")
...
# from Slingshot:
load("RDATA/Manuscript/slingshot_dyntoyDC1.RData")
ushap_ss_evals <- mclapply(resobjs, UshapeDetector)
lapply(ushap_ss_evals, function(x) x$Ambpct)


# from Monocle3:
load("RDATA/Manuscript/Monocle3_dyntoyDC1.RData")
