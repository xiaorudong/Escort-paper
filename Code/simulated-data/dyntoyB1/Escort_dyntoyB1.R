...
scdata <- readRDS("DATA/sc_benchmark/synthetic_dyntoy_bifurcating_1.rds")
...
save(norm_counts, rawcounts, scdata_time, 
     file = "RDATA/Manuscript/clean_dyntoy_B1.RData")
...
save(embeddings, file = "RDATA/Manuscript/dr_dyntoy_B1.RData")
...
# from Slingshot:
load("RDATA/Manuscript/slingshot_dyntoyB1.RData")
ushap_ss_evals <- mclapply(resobjs, UshapeDetector)
lapply(ushap_ss_evals, function(x) x$Ambpct)


# from Monocle3:
load("RDATA/Manuscript/Monocle3_dyntoyB1.RData")
