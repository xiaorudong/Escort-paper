...
load("RDATA/Manuscript/clean_dyntoy_B1.RData")
load("RDATA/Manuscript/dr_dyntoy_B1.RData")
...
save(fitLines, resobjs, file = "RDATA/Manuscript/slingshot_dyntoyB1.RData")
