...
# lung_sim_DEG_20_CELLS_500
load("DATA/scLANE_sims/lung_sim_DEG_20_CELLS_500.RDATA")
...
save(norm_counts, rawcounts, scdata_time, 
     file = "RDATA/Manuscript/clean_DEG20.RData")
...
save(embeddings, file = "RDATA/Manuscript/dr_DEG20.RData")
