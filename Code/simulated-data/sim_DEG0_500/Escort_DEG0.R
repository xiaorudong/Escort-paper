...
sim_data <- readRDS("DATA/simScaffold_forRuby_0pctcell500.rds")
rawcounts <- sim_data@assays@data@listData[["umi_counts"]]
scdata_time <- sim_data@colData@listData[["cell_time_normed"]]
names(scdata_time) <- sim_data@colData@rownames
...
save(norm_counts, rawcounts, scdata_time, 
     file = "RDATA/Manuscript/clean_DEG0.RData")
...
cor_test$decision # homogeneous cells
cor_test$signal_pct
...
save(embeddings, file = "RDATA/Manuscript/dr_DEG0.RData")
