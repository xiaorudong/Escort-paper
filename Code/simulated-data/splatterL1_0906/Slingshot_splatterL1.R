...
load("RDATA/Manuscript/clean_splatter_L1.RData")
load("RDATA/Manuscript/dr_splatter_L1.RData")
...
save(fitLines, resobjs, file = "RDATA/Manuscript/slingshot_splatterL1.RData")
