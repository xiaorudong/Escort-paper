...
load("RDATA/Manuscript/clean_dyntoy_M4.RData")
load("RDATA/Manuscript/dr_dyntoy_M4.RData")
...
save(fitLines, resobjs, file = "RDATA/Manuscript/slingshot_dyntoyM4.RData")
