...
load("RDATA/step0_m3_realGold_astrocyte.RData")
...
load("RDATA/res_realGold_astrocyte.RData")
...
pdf("PLOTS/Script_realGold_astrocyte/ushape_m3_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
...
save(scoredf, final_df, file = "RDATA/res_m3_realGold_astrocyte.RData")
save.image(file = "RDATA/allres_m3_realGold_astrocyte.RData")
