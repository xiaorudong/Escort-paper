...
pdf("PLOTS/Script_dyntoy_M4/method_m3_evaluation.pdf", onefile = TRUE, width = 8, height = 8)
...
# PT distributions
pdf("PLOTS/Script_dyntoy_M4/method_m3_evaluation2.pdf", onefile = TRUE, width = 12, height = 12)
library(gridExtra)
# select genes
library(scuttle)
library(scran)
...
pdf("PLOTS/Script_dyntoy_M4/method_m3_evaluation_corr.pdf", onefile = TRUE, width = 5, height = 5)
par(mfrow=c(1,1))
library(corrplot)
