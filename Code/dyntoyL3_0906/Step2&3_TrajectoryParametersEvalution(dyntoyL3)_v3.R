...
# dir.create("PLOTS/Script_dyntoy_L3")
...
load("RDATA/step0_ss_dyntoy_L3.RData")
load("RDATA/step1_dyntoy_L3.RData")
...
pdf("PLOTS/Script_dyntoy_L3/gof_ss_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
...
pdf("PLOTS/Script_dyntoy_L3/ushape_ss_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
...
save(scoredf, final_df, file = "RDATA/res_dyntoy_L3.RData")
save.image(file = "RDATA/allres_dyntoy_L3.RData")
