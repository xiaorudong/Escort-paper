...
# dir.create("PLOTS/Script_realGold_germlineFemale")
...
load("RDATA/step0_clean_realGold_germlineFemale.RData")
load("RDATA/step0_ss_realGold_germlineFemale.RData")
load("RDATA/step1_realGold_germlineFemale.RData")
...
pdf("PLOTS/Script_realGold_germlineFemale/gof_ss_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
...
pdf("PLOTS/Script_realGold_germlineFemale/ushape_ss_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
...
save(scoredf, final_df, file = "RDATA/res_realGold_germlineFemale.RData")
save.image(file = "RDATA/allres_realGold_germlineFemale.RData")
