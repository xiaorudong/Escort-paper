...
# scdata <- subset(scdata, subset = nFeature_RNA > 1000 & nFeature_RNA < 5000 & percent.mt < 8.5)
...
save(norm_counts, rawcounts, scdata_time, 
     file = "RDATA/step0_clean_sim_DEG0_500.RData")
...
save(dimred1, dimred2, dimred3,
     ...
     file = "RDATA/step0_dr_sim_DEG0_500.RData")
