...
load("RDATA/step0_ss_RealCollection1.RData")
...
pdf("PLOTS/Script_RealCollection1/gof_ss_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
...
gof_eval7 <- GOFeval(UMAP7_eval, alpha = 3)
gof_eval8 <- GOFeval(UMAP8_eval, alpha = 3)
...
pdf("PLOTS/Script_RealCollection1/ushape_ss_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
...
save(scoredf, final_df, file = "RDATA/res_RealCollection1.RData")
save.image(file = "RDATA/allres_RealCollection1.RData")
