...
# dir.create("PLOTS/Script_realGold_ageHSC")
...
load("RDATA/step0_clean_realGold_ageHSC.RData")
load("RDATA/step0_m3_realGold_ageHSC.RData")
load("RDATA/step1_realGold_ageHSC.RData")



######################## STEP 2:########################

load("RDATA/res_realGold_ageHSC.RData")
...
pdf("PLOTS/Script_realGold_ageHSC/ushape_m3_evaluation.pdf", onefile = TRUE, width = 8, height = 4.5)
par(mfrow=c(1, 2))
...
save(scoredf, final_df, file = "RDATA/res_m3_realGold_ageHSC.RData")
save.image(file = "RDATA/allres_m3_realGold_ageHSC.RData")
