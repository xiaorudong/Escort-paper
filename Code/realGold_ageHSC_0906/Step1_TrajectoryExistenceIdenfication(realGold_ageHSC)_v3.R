...
par(mfrow = c(2, 2))
# dist_mat <- dist(t(correct_counts), method = 'manhattan')
dist_mat <- parDist(t(correct_counts), method = "manhattan")
...
cor_test <- testHomogeneous(HVGs=HVGs, norm_counts=correct_counts, num.sim = 1000)
cor_test$signal_pct
cor_test$decision
